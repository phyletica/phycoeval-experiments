...
\begin{figure}
    ...
    \begin{subfigure}[c][][c]{0.59\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../fixed-gen-euclidean-distances-sans-cropped.pdf}
    \end{subfigure}
    ...
    \begin{subfigure}[c][][c]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../fixed-gen-gen-true-tree-probs-sans-cropped.pdf}
    \end{subfigure}
    ...
    \begin{subfigure}[c][][c]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../fixed-gen-max-wrong-root-poly-subsplit-probs-sans-cropped.pdf}
    \end{subfigure}
\end{figure}
