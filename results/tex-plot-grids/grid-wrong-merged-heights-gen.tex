...
\begin{figure}
    ...
    \begin{tabular}{@{}ccc@{}}
        ...
        \includegraphics[width=0.45\textwidth]{../unfixed-gen-gen-wrong-merged-height-probs-age-separate-sans-cropped.pdf}
        & \multicolumn{1}{c|}{\multirow{1}{*}[7.7em]{\begin{sideways}\Large All sites\end{sideways}}}
        & \\
        \includegraphics[width=0.45\textwidth]{../unfixed-gen-gen-var-only-wrong-merged-height-probs-age-separate-sans-cropped.pdf}
        ...
        & & \\
        \includegraphics[width=0.45\textwidth]{../locus-100-unfixed-gen-gen-wrong-merged-height-probs-age-separate-sans-cropped.pdf}
        & \multicolumn{1}{c|}{\multirow{1}{*}[7.7em]{\begin{sideways}\Large All sites\end{sideways}}}
        & \\
        \includegraphics[width=0.45\textwidth]{../locus-100-unfixed-gen-gen-var-only-wrong-merged-height-probs-age-separate-sans-cropped.pdf}
