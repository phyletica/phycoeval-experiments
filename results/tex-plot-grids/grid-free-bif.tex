...
\begin{figure}
    ...
    \begin{subfigure}[c][][c]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../unfixed-bif-euclidean-distances-sans-cropped.pdf}
    \end{subfigure}
    \begin{subfigure}[b][][l]{\textwidth}
        \insertlabel
    \end{subfigure}
    ...
    \begin{subfigure}[c][][c]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../unfixed-bif-mean-split-probs-sans-cropped.pdf}
    \end{subfigure}
\end{figure}
