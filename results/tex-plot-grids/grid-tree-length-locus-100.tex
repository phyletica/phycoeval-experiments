...
\begin{figure}
    ...
    \begin{tabular}{@{}ccccccc@{}}
        ...
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-gen-gen-all-tree-length.pdf}
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-gen-bif-all-tree-length.pdf}
        &
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-bif-gen-all-tree-length.pdf}
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-bif-bif-all-tree-length.pdf}
        & \multirow{1}{*}[9em]{\begin{sideways}\Large All sites\end{sideways}} \\
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-gen-gen-var-tree-length.pdf}
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-gen-bif-var-tree-length.pdf}
        &
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-bif-gen-var-tree-length.pdf}
        & \includegraphics[width=0.19\textwidth]{../locus-100-free-bif-bif-var-tree-length.pdf}
