...
\begin{figure}
    ...
    \begin{tabular}{@{}ccccccc@{}}
        ...
        & \includegraphics[width=0.19\textwidth]{../free-gen-gen-all-root_pop_size.pdf}
        & \includegraphics[width=0.19\textwidth]{../free-gen-bif-all-root_pop_size.pdf}
        &
        & \includegraphics[width=0.19\textwidth]{../free-bif-gen-all-root_pop_size.pdf}
        & \includegraphics[width=0.19\textwidth]{../free-bif-bif-all-root_pop_size.pdf}
        & \multirow{1}{*}[9em]{\begin{sideways}\Large All sites\end{sideways}} \\
        & \includegraphics[width=0.19\textwidth]{../free-gen-gen-var-root_pop_size.pdf}
        & \includegraphics[width=0.19\textwidth]{../free-gen-bif-var-root_pop_size.pdf}
        &
        & \includegraphics[width=0.19\textwidth]{../free-bif-gen-var-root_pop_size.pdf}
        & \includegraphics[width=0.19\textwidth]{../free-bif-bif-var-root_pop_size.pdf}
