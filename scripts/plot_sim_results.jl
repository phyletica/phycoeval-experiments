...
function main_cli()::Cint
    ...
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-root-vln.pdf"))
    ...
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-root-all-sites-vln.pdf"))
    ...
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-root-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-789-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-789-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-789-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-456-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-456-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-456-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-12-3-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-12-3-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-node-probs-12-3-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-12-789-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-12-789-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-12-789-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-123-456-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-123-456-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-height-probs-123-456-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-split-probs-12-vln.pdf"))
    ...
    Plots.ylims!(v, (0.0, 1.0))
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-split-probs-12-all-sites-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-split-probs-12-all-sites-hist.pdf"))
    ...
    #= Plots.ylabel!(v, "Posterior probability") =#
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-topo-probs-vln.pdf"))
    ...
    Plots.plot!(h, size = (140, 120), yaxis = false, grid = :x, xticks = (0:0.5:1))
    Plots.savefig(h,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-topo-probs-all-sites-hist.pdf"))
    ...
    Plots.ylabel!(v, "Posterior probability")
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-true-tree-probs.pdf"))
    ...
    # Plots.savefig(vln_grid, joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-gen-true-tree-probs.pdf"))
    ...
    bif_gen_true_topo_probs = get_floats(results, true, false, true, false, :topo_true_prob)
    vo_bif_gen_true_topo_probs = get_floats(results, true, false, true, true, :topo_true_prob)
    bif_bif_true_topo_probs = get_floats(results, true, false, false, false, :topo_true_prob)
    vo_bif_bif_true_topo_probs = get_floats(results, true, false, false, true, :topo_true_prob)
    ...
    Plots.savefig(v,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed-bif-true-topo-probs.pdf"))
    ...
    Plots.savefig(v, joinpath(ProjectUtil.RESULTS_DIR, "fixed-bif-gen-wrong-probs.pdf"))
    ...
    fixed_bif_bif_dist_lower = get_floats(results,
            true, false, false, false,
            :euclidean_distance_eti_95_lower)
    fixed_bif_bif_dist_upper = get_floats(results,
            true, false, false, false,
            :euclidean_distance_eti_95_upper)
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "fixed-gen-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "fixed-bif-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-gen-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-gen-all-sites-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-gen-var-only-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-bif-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-bif-all-sites-euclidean-distances.pdf"))
    ...
    Plots.savefig(p, joinpath(ProjectUtil.RESULTS_DIR, "unfixed-bif-var-only-euclidean-distances.pdf"))
    ...
    Plots.savefig(vln_fixed_gen_asdsf,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed_gen_asdsf.pdf"))
    ...
    Plots.savefig(vln_fixed_bif_asdsf,
            joinpath(ProjectUtil.RESULTS_DIR, "fixed_bif_asdsf.pdf"))
    ...
    Plots.savefig(vln_unfixed_gen_asdsf,
            joinpath(ProjectUtil.RESULTS_DIR, "unfixed_gen_asdsf.pdf"))
    ...
    Plots.savefig(vln_unfixed_bif_asdsf,
            joinpath(ProjectUtil.RESULTS_DIR, "unfixed_bif_asdsf.pdf"))
