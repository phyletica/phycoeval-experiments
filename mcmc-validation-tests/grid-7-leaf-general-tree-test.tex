...
\begin{figure}
    ...
    \centering
    \begin{tabular}{@{}cc@{}}
        \includegraphics[height=0.19\textwidth]{7-leaf-general-tree-test-count-distribution.pdf}
        &
        \includegraphics[height=0.19\textwidth]{7-leaf-general-tree-test-qq.pdf}
        \\
    \end{tabular}
\end{figure}
